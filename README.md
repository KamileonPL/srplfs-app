# **SRPLFS application for Live For Speed**
...
### How to install
1. Download latest [release](https://github.com/KamileonPL/srplfs-app/releases/download/v0.0.6/SRPLFS.zip) and unzip the archive,
